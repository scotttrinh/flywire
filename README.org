...
The core entry point is ~flywire-do~, which accepts a native Elisp list describing a sequence of actions.

#+begin_src elisp
;; Using Elisp structure
(flywire-do
 '(((action . "type") (text . "Hello World"))
   ((action . "key") (chord . "RET"))))

;; If you have a JSON string (e.g. from an external process), parse it first:
(let ((json-string "[{\"action\": \"type\", \"text\": \"Hello\"}]"))
  (flywire-do
